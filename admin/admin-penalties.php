...
// Get penalties (no users table dependency, and avoid non-existent due-date columns)
$penalties_query = "SELECT p.*, t.transaction_date 
                   FROM penalties p 
                   LEFT JOIN transactions t ON p.transaction_id = t.id 
                   $where_clause
                   ORDER BY p.violation_date DESC, p.created_at DESC";
...
{{ ... }}
                ...
                <li class="nav-item active">
                    <a href="admin-penalties.php"><i class="fas fa-gavel"></i><span>Penalty Management</span></a>
                </li>
            </ul>
        ...
        <main class="main-content">
            ...
            <section class="content-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3 class="stat-number">₱<?= number_format($stats['total_pending'], 2) ?></h3>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3 class="stat-number">₱<?= number_format($stats['total_collected'], 2) ?></h3>
            ...
            <section class="content-section">
                ...
                <form method="GET" class="filter-form">
                    ...
                    <a href="admin-penalties.php" class="btn btn-secondary">
                            ...
                            <tbody>
                                <?php while ($penalty = $penalties_result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="amount">₱<?= number_format($penalty['penalty_amount'], 2) ?></td>
        ...
        function updatePenaltyPreview() {
            ...
            if (penaltyType && penaltyAmount > 0) {
                let previewContent = `
                    ...
                    <p><strong>Amount:</strong> ₱${penaltyAmount.toFixed(2)}</p>
